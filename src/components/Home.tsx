...
function Header({ scrollToQuote }: { scrollToQuote: () => void }) {
    return <motion.header className="relative w-full flex flex-col px-6 h-[250px] sm:h-[300px] items-center justify-center">
        <img src="/header.png" className="absolute top-0 left-0 w-full h-full object-cover img-blur" />
        <motion.div className="z-20 flex flex-col items-center text-white">
<motion.h1 variants={itemVariants} className="text-4xl sm:text-6xl font-header text-green-500">Jace Genereux</motion.h1>
            <motion.span variants={itemVariants} className="text-2xl sm:text-3xl md:text-4xl font-body text-center">Bring your website idea to life</motion.span>
            <motion.button
